...
public class Mapper {
    ...
    public Mapper(UserRepo userRepo, TopicRepo topicRepo, PostRepo postRepo) {
    ...
    public Post dtoToPost(NewPostDto dto, User author) {
        return new Post(
                dto.getTitle(),
                dto.getText(),
                author,
...
//     TODO comment graph
//    public Comment dtoToCascadingComment(NewCommentDto dto) {
//        return new Comment(
//                dto.getText(),
//                userRepo.getById(dto.getAuthorId()),
//                postRepo.getById(dto.getPostId()),
...
//    }
//
//    public List<CommentDto> cascadingCommentsToDto(Collection<CascadingComment> comments) {
//    List<Comment> originalComments = comments.stream()
//            .filter(c -> c.getReplyTo().equals(null))
//            .sorted(Comparator.comparing(Comment::getPostDate))
//            .collect(Collectors.toList());
//    return setReplies(originalComments);
//    }
//
//    private List<CommentDto> setReplies(Collection<CascadingComment> comments) {
//        return comments.stream()
